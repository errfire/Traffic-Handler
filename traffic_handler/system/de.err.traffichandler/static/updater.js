        ...
        if (compareVersions(currentVersion, serverVersion)) {
            ...
            alertContainer.innerHTML = `
                <div class="alert alert-warning alert-dismissible fade show" role="alert">
                    <strong>Eine neue Version ${serverVersion} wurde veröffentlicht!</strong> Sie verwenden eine ältere Version. <a href="https://github.com/errfire/Traffic-Handler-Docker/releases/tag/${serverVersion}" class="alert-link">Jetzt herunterladen</a>
